...
def main():
    ...
    clear_folder = '/data/fhdmi/train/target'# fix to your path
    moire_folder = '/data/fhdmi/train/source'# fix to your path
    save_clear_folder = '/data/fhdmi_patches/train/clear/'# fix to your path
    save_moire_folder = '/data/fhdmi_patches/train/moire/'# fix to your path
