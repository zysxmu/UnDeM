...
def main():
    ...
    clear_folder = '/data/UHDM/train_all/clear'# fix to your path
    moire_folder = '/data/UHDM/train_all/moire'# fix to your path
    save_clear_folder = '/data/uhdm_patches/train/clear/'# fix to your path
    save_moire_folder = '/data/uhdm_patches/train/moire/'# fix to your path

    crop_sz = (4032//2, 3024//3)  # the size of each sub-image (clear)
    step = (4032//2, 3024//3)  # step of the sliding crop window (clear)
